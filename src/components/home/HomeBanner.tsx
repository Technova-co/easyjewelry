...
const HomeV2Banner: React.FC<HomeV2BannerProps> = ({
  ...
  description = 'EasyJewelry brings every part of your jewelry business into one place — inventory, billing, accounts, and even your online store, across all your locations.',
